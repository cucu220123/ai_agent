...
def train(train_df, target_col, config=None):
    ...
    model = Pipeline(steps=[
        ...
        ('classifier', LogisticRegression(C=1.0, max_iter=100, class_weight='balanced', random_state=random_state))
    ])
...
def predict(model, test_df):
    ...
    return pd.DataFrame({'prediction': prediction, 'probability': probability})
